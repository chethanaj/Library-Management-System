...
import { ReserveDialogComponent } from './dialogs/reserve/reserve.dialog.component';
...
export class ReserveBookComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'isbn', 'title', 'subject', 'publisher', 'language', 'noOfPages','authors','reserve'];
  ...
  addReserveBook(id:number,isbn:string){
  this.id=id;
