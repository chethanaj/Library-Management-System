package lk.chethana.apigateway.security.provider;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.JwtException;
import io.jsonwebtoken.Jwts;
import io.jsonwebtoken.SignatureAlgorithm;
import lk.chethana.apigateway.model.AppUserDetails;
...
public class JwtTokenProvider {
    ...
    public UserDetails getUserDetails(String token) {
        ...
        UserDetails userDetails = new AppUserDetails(userName,roleList.toArray(new String[roleList.size()]));
        return userDetails;
    }
